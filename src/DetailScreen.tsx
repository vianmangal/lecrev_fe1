...
export const DetailScreen: React.FC<DetailScreenProps> = ({ project, onBack, activeTab, setActiveTab }) => {
    ...
    >
      ...
      <div className="grid grid-cols-2 gap-16 mb-12">
        <div className="grid grid-cols-2 gap-6">
          {[["Branch", "main"], ["Commit", "7a0f3d2"], ["Region", "LHR"],
          ["Instances", "24"], ["Age", "2m"], ["Version", "v2.4.1"]].map(([k, v]) => (
            <div key={k}>
